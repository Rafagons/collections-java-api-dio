...
public class ConjuntoConvidados {
  ...
  public static void main(String[] args) {
    ...
    conjuntoConvidados.adicionarConvidado("Ana Carolina", 1990);
    conjuntoConvidados.adicionarConvidado("Rafael", 1996);
    conjuntoConvidados.adicionarConvidado("Marcia", 1960);
    conjuntoConvidados.adicionarConvidado("Rosemberg", 1941);
